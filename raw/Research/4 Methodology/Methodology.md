...
The process I'm using has 6 main phases, research/interviews, sketching and looks like modeling, works like modeling, complete prototypes, final testing, and open sourcing it to give back to the communities that helped create it. As Peter Kropotkin spoke of in The Conquest of Bread "By what right then can anyone whatever appropriate the least morsel of this immense whole and say – This is mine, not yours?" 
### Phase 1: Research
...
Some interview questions for Gen Z participants:
- When was the last time you were bored with no phone nearby? What did that feel like?
- If you had a small object in your pocket that wasn't a phone, what would make you reach for it instead?
- What does "doing nothing" mean to you? Is it appealing or uncomfortable?
